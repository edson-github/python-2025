...
#     sleep(delay)  # Changed from time.sleep to sleep
...
# threads = []
# for link in links:
#     # Using `args`to pass positional arguments and `kwargs` to pass keyword arguments
#     t = Thread(target=crawl, args=(link,), kwargs={"delay": 3})
#     threads.append(t)
...
from threading import Thread  # Adicionada importação necessária
from time import sleep
